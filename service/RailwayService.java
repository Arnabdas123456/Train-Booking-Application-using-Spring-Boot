...
public class RailwayService {
	...
	**/
		...
		{
			throw new TicketNotFoundException("Ticket is not found for pnr"+pnr);
		}
	...
	**/
		if(ObjectUtils.isEmpty(list.add(ticket)))
		{
			throw new TicketAlreadyExistsException("Ticked is already exist"+ticket);
		}
		list.add(ticket);
